...
The example Air Traffic Controller for Open Requisitions takes Headcount Optimization signal, feeds it into Load Balancing to run req-to-recruiter allocation, and produces per-req explainable recommendations that lands on the requisition record as a custom object.
