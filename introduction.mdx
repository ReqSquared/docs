...
Three cubes wired together produce the full Air Traffic Controller for Open Requisitions. Each cube does its job. Each cube's output flows into the next cube. The final cube produces the operational Health Score that lands on the requisition record.

![Step2 Abstract 3 Cubes 1](/images/step2_abstract_3_cubes_1.png)
...
<AccordionGroup>
  ...
  <Accordion title="Decisions flows forward.">
